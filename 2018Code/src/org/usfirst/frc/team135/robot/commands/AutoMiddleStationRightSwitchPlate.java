...
public class AutoMiddleStationRightSwitchPlate extends CommandGroup {
    ...
    public AutoMiddleStationRightSwitchPlate() {
    	addSequential(new AutoDriveDiagonal(RobotMap.midRightSwitch, RobotMap.rightSwitchAngle));
    	//addSequential(new AutoLift());
    	addSequential(new AutoDriveStraight(RobotMap.midRightSwitchStraight));
